...
export const fr = {
  ...
  BOOKING_REQUEST_SUBJECT: 'Nouvelle demande de réservation',
  BOOKING_REQUEST_ADMIN_INTRO: 'Une nouvelle demande de réservation attend votre validation.',
  BOOKING_REQUEST_ADMIN_ACTION: 'Veuillez ouvrir la réservation dans l’interface d’administration pour l’accepter ou la refuser.',
  BOOKING_REQUEST_RECEIVED_SUBJECT: 'Demande de réservation reçue',
  BOOKING_REQUEST_RECEIVED_INTRO: 'Nous avons reçu votre demande de réservation et l’avons transmise pour validation.',
  BOOKING_REQUEST_RECEIVED_NEXT_STEPS: 'Notre équipe vous contactera prochainement.',
  ...
  BOOKING_STATUS_VOID: 'Invalide',
  REQUESTED_BY: 'Demandée par',
  COMPANY: env.WEBSITE_NAME,
  CAR: 'Véhicule',
  TO: 'Date de restitution',
  BOOKING_CREATED_NOTIFICATION_PART1: 'Une nouvelle réservation',
  BOOKING_CREATED_NOTIFICATION_PART2: 'a été créée.',
  BOOKING_STATUS_CHANGED_NOTIFICATION_PART1: 'Le statut de la réservation',
  BOOKING_STATUS_CHANGED_NOTIFICATION_PART2: 'est passé de',
  BOOKING_STATUS_CHANGED_NOTIFICATION_PART3: 'à',
}
