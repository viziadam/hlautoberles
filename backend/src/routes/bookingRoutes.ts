...
import * as bookingStatusController from '../controllers/bookingStatusController'
...
routes.route(routeNames.updateStatus).post(authJwt.verifyToken, bookingStatusController.updateStatus)
