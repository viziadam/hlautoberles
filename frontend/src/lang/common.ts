...
const strings = new LocalizedStrings({
  ...
  en: {
    ...
    AUTHENTICATED_ERROR: 'You must be logged in to perform this action',
 ...
 hu: {
  ...
  ALL: 'Összes',
  TOS: 'Elolvastam és elfogadom a Felhasználási feltételeket.',
  BIRTH_DATE: 'Születési dátum',
  RECAPTCHA_ERROR: 'reCAPTCHA hiba',
  AUTHENTICATED_ERROR: 'A művelethez be kell jelentkezned.',
  TOS_ERROR: 'Fogadd el a Felhasználási feltételeket.',
  BIRTH_DATE_NOT_VALID: `Legalább ${env.MINIMUM_AGE} évesnek kell lenned.`,
  ...
  BACK: 'Vissza',
  NEXT: 'Következő',
  LOCATION_TERM: 'Helyszín / kifejezés',
  EDIT: 'Szerkesztés',
  OR: 'vagy',
