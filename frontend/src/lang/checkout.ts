...
const strings = new LocalizedStrings({
  ...
  hu: {
  BOOKING_HEADING: 'Foglalás',
  BOOKING_OPTIONS: 'Foglalási beállítások',
  BOOKING_DETAILS: 'Foglalás részletei',
  DAYS: 'Napok',
  CAR: 'Jármű',
  SUPPLIER: 'Szolgáltató',
  COST: 'Összeg',
  DRIVER_DETAILS: 'Sofőr adatai',
  EMAIL_INFO: 'Erre a címre küldjük a visszaigazoló emailt.',
  PHONE_INFO: 'Ha sürgősen el kell érnünk.',
  PAYMENT: 'Biztonságos fizetés',
  CARD_NUMBER: 'Kártyaszám',
  CARD_NUMBER_NOT_VALID: 'Érvénytelen kártyaszám',
  CARD_EXPIRY_NOT_VALID: 'Érvénytelen lejárati dátum',
  CVV_NOT_VALID: 'Érvénytelen CVC/CVV kód',
  BOOK: 'Foglalás',
  SIGN_IN: 'Bejelentkezés?',
  SECURE_PAYMENT_INFO: 'Adataid SSL titkosítással védettek.',
  SUCCESS: 'A fizetés sikeres volt. Visszaigazoló emailt küldtünk.',
  PAY_LATER_SUCCESS: 'A foglalás sikeres volt. Visszaigazoló emailt küldtünk.',
  PAYMENT_OPTIONS: 'Fizetési lehetőségek',
  PAY_LATER: 'Fizetés átvételkor',
  PAY_LATER_INFO: 'A teljes összeget az autó átvételekor fizeted. Előfordulhat visszatérítendő kaució.',
  PAY_DEPOSIT: 'Kaució online fizetése és foglalás megerősítése',
  PAY_DEPOSIT_INFO: 'A kaució online fizetésével megerősíted a foglalást. A fennmaradó összeget átvételkor fizeted.',
  DEPOSIT: 'Kaució',
  PAY_ONLINE: 'Foglalás kaució nélkül',
  PAY_ONLINE_INFO: 'Foglalás előleg nélkül. A teljes összeget átvételkor fizeted.',
  PAY_IN_FULL: 'Teljes összeg online fizetése',
  PAY_IN_FULL_INFO: 'Kaucióval együtt. Módosítás és lemondás feltételekhez kötött.',
  PAYMENT_FAILED: 'A fizetés nem sikerült.',
  CHECKING: 'Ellenőrzés folyamatban...',
  LICENSE_REQUIRED: 'Vezetői engedély szükséges',
  PRICE_FOR: 'Ár ennyire:',
  DAY: 'nap',
  PICK_UP_CHECKLIST_TITLE: 'Átvételi ellenőrzőlista',
  PICK_UP_CHECKLIST_ARRIVE_ON_TIME_TITLE: 'Érkezz időben',
  PICK_UP_CHECKLIST_ARRIVE_ON_TIME_CONTENT:
    'A kölcsönző általában csak a lefoglalt átvételi időpontban adja át a kulcsokat. A járművet sokszor csak korlátozott ideig tartják fent, késés esetén átadhatják másnak.',
  PICK_UP_CHECKLIST_DOCUMENTS_TITLE: 'Mit hozz magaddal',
  PICK_UP_CHECKLIST_DOCUMENTS_CONTENT:
    'Az átvételhez útlevélre vagy személyi igazolványra, valamint érvényes jogosítványra lesz szükséged.',
},
})
