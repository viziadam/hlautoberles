...
const strings = new LocalizedStrings({
  ...
  hu: {
    ...
    CAR_CURRENCY: `${commonStrings.CURRENCY}/nap`,
    ...
    FUEL_POLICY_LIKE_FOR_LIKE_TOOLTIP: 'A járművet ugyanannyi üzemanyaggal kell visszahozni, mint átvételkor.',
    FUEL_POLICY_FREE_TANK_TOOLTIP: 'Az ár tartalmazza a teljes üzemanyagtartályt.',
    FUEL_POLICY_FULL_TO_FULL_TOOLTIP: 'A járművet tele tankkal kapod és tele tankkal kell visszahozni.',
    FUEL_POLICY_FULL_TO_EMPTY_TOOLTIP: 'A járművet tele tankkal kapod, üresen kell visszahozni.',
    ...
    CANCELLATION_TOOLTIP: 'A foglalás a bérlés megkezdése előtt lemondható.',
    AMENDMENTS: 'Módosítás',
    AMENDMENTS_TOOLTIP: 'A foglalás a bérlés megkezdése előtt módosítható.',
    THEFT_PROTECTION: 'Lopásbiztosítás',
    THEFT_PROTECTION_TOOLTIP: 'A bérlés lopás elleni védelmet tartalmazhat.',
    COLLISION_DAMAGE_WAVER: 'Káresemény önrész',
    COLLISION_DAMAGE_WAVER_TOOLTIP: 'A bérlés tartalmazhat töréskár fedezetet.',
    FULL_INSURANCE: 'Teljes biztosítás',
    FULL_INSURANCE_TOOLTIP: 'A bérlés tartalmazhat töréskár és lopáskár fedezetet a járműre.',
    ...
    CAR_AVAILABLE: 'Megjelenik a keresési találatokban',
    CAR_AVAILABLE_TOOLTIP: 'Ez a jármű megjelenik a keresési találatokban.',
    CAR_UNAVAILABLE: 'Nem jelenik meg a keresési találatokban',
    CAR_UNAVAILABLE_TOOLTIP: 'Ez a jármű nem jelenik meg a keresési találatokban.',

    VIEW_CAR: 'Jármű megtekintése',
    EMPTY_LIST: 'Nincs elérhető jármű.',
    CANNOT_DELETE_CAR: 'A jármű nem törölhető, mert foglalásokhoz van kapcsolva. Viszont szerkesztéssel nem foglalhatóvá teheted.',

    GEARBOX: 'Sebességváltó',
    ENGINE: 'Meghajtás',
    DEPOSIT: 'Kaució átvételkor',

    LESS_THAN_VALUE_1: `Kevesebb mint ${env.DEPOSIT_FILTER_VALUE_1} ${env.CURRENCY}`,
    LESS_THAN_VALUE_2: `Kevesebb mint ${env.DEPOSIT_FILTER_VALUE_2} ${env.CURRENCY}`,
    LESS_THAN_VALUE_3: `Kevesebb mint ${env.DEPOSIT_FILTER_VALUE_3} ${env.CURRENCY}`,
