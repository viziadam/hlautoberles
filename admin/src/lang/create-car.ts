...
const strings = new LocalizedStrings({
  ...
  en: {
    ...
    AVAILABLE: 'Available',
    CAR_TYPE: 'Engine',
    DAILY_PRICE: 'Daily Price(1-3)',
    DISCOUNTED_DAILY_PRICE: 'Discounted Daily Price(4-6)',
    ...
    WEEKLY_PRICE: 'Weekly Price(1-2)',
    DISCOUNTED_WEEKLY_PRICE: 'Discounted Weekly Price(3-4)',
  ...
  hu: {
    ...
    DAILY_PRICE: 'Napi ár(1-3)',
    DISCOUNTED_DAILY_PRICE: 'Kedvezményes napi ár(4-6)',
    ...
    WEEKLY_PRICE: 'Heti ár(1-2)',
    DISCOUNTED_WEEKLY_PRICE: 'Kedvezményes heti ár(3-4)',
